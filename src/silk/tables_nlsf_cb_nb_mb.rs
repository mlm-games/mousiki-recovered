//! Port of the SILK narrowband/midband NLSF codebook tables from
//! `silk/tables_NLSF_CB_NB_MB.c`.
//!
//! The tables expose the narrowband and mediumband NLSF codebook used during
//! stage-one and stage-two decoding of line spectral frequencies.

use super::tables_nlsf_cb_wb::SilkNlsfCb;

#[rustfmt::skip]
pub const SILK_NLSF_CB1_NB_MB_Q8: [u8; 320] = [
...
#[rustfmt::skip]
pub const SILK_NLSF_CB1_NB_MB_WGHT_Q9: [i16; 320] = [
...
#[rustfmt::skip]
pub const SILK_NLSF_CB1_ICDF_NB_MB: [u8; 64] = [
...
#[rustfmt::skip]
pub const SILK_NLSF_CB2_SELECT_NB_MB: [u8; 160] = [
        16,      0,      0,      0,      0,     99,     66,     36,
...
#[rustfmt::skip]
pub const SILK_NLSF_CB2_BITS_NB_MB_Q5: [u8; 72] = [
...
#[rustfmt::skip]
pub const SILK_NLSF_PRED_NB_MB_Q8: [u8; 18] = [
...
#[rustfmt::skip]
pub const SILK_NLSF_DELTA_MIN_NB_MB_Q15: [i16; 11] = [
       250,      3,      6,      3,      3,      3,      4,      3,
         3,      3,    461
];
...
pub static SILK_NLSF_CB_NB_MB: SilkNlsfCb = SilkNlsfCb {
    ...
    cb1_wght_q9: &SILK_NLSF_CB1_NB_MB_WGHT_Q9,
...
mod tests {
    ...
    #[test]
    fn nb_mb_codebook_metadata_matches_reference() {
        assert_eq!(SILK_NLSF_CB_NB_MB.n_vectors, 32);
        assert_eq!(SILK_NLSF_CB_NB_MB.order, 10);
        assert_eq!(SILK_NLSF_CB_NB_MB.quant_step_size_q16, 11796);
        assert_eq!(SILK_NLSF_CB_NB_MB.inv_quant_step_size_q6, 356);
        assert_eq!(SILK_NLSF_CB_NB_MB.cb1_nlsf_q8.len(), 320);
        assert_eq!(SILK_NLSF_CB_NB_MB.cb1_nlsf_q8[0], 12);
        assert_eq!(SILK_NLSF_CB_NB_MB.cb1_nlsf_q8[319], 230);
        assert_eq!(SILK_NLSF_CB_NB_MB.cb1_wght_q9.len(), 320);
        assert_eq!(SILK_NLSF_CB_NB_MB.cb1_icdf.len(), 64);
        assert_eq!(SILK_NLSF_CB_NB_MB.ec_sel.len(), 160);
        assert_eq!(SILK_NLSF_CB_NB_MB.ec_icdf.len(), 72);
        assert_eq!(SILK_NLSF_CB_NB_MB.ec_rates_q5.len(), 72);
        assert_eq!(SILK_NLSF_CB_NB_MB.delta_min_q15.len(), 11);
        assert_eq!(SILK_NLSF_CB_NB_MB.delta_min_q15[0], 250);
        assert_eq!(SILK_NLSF_CB_NB_MB.delta_min_q15[10], 461);
    }
}

//! Port of `silk/tables_pulses_per_block.c` (Opus/SILK).
//! Source: https://gitlab.xiph.org/xiph/opus/-/blob/v1.5.2/silk/tables_pulses_per_block.c
//! Values copied verbatim; see the upstream license header for provenance.
//!
//! These tables are used by the shell coder and related entropy
//! decoding routines.
...
[129,   0, 203,  54,   0, 234, 129,  23,   0, 245, 184,  73,  10,   0, 250, 215, 129,  41,   5,   0, 252, 232, 173,  86,  24,   3,   0, 253, 240, 200, 129,  56,  15,   2,   0, 253, 244, 217, 164,  94,  38,  10,   1,   0, 253, 245, 226, 189, 132,  71,  27,   7,   1,   0, 253, 246, 231, 203, 159, 105,  56,  23,   6,   1,   0, 255, 248, 235, 213, 179, 133,  85,  47,  19,   5,   1,   0, 255, 254, 243, 221, 194, 159, 117,  70,  37,  12,   2,   1,   0, 255, 254, 248, 234, 208, 171, 128,  85,  48,  22,   8,   2,   1,   0, 255, 254, 250, 240, 220, 189, 149, 107,  67,  36,  16,   6,   2,   1,   0, 255, 254, 251, 243, 227, 201, 166, 128,  90,  55,  29,  13,   5,   2,   1,   0, 255, 254, 252, 246, 234, 213, 183, 147, 109,  73,  43,  22,  10,   4,   2,   1,   0];

#[rustfmt::skip]
pub static SILK_SHELL_CODE_TABLE3: [u8; 152] =
[130,   0, 200,  58,   0, 231, 130,  26,   0, 244, 184,  76,  12,   0, 249, 214, 130,  43,   6,   0, 252, 232, 173,  87,  24,   3,   0, 253, 241, 203, 131,  56,  14,   2,   0, 254, 246, 221, 167,  94,  35,   8,   1,   0, 254, 249, 232, 193, 130,  65,  23,   5,   1,   0, 255, 251, 239, 211, 162,  99,  45,  15,   4,   1,   0, 255, 251, 243, 223, 186, 131,  74,  33,  11,   3,   1,   0, 255, 252, 245, 230, 202, 158, 105,  57,  24,   8,   2,   1,   0, 255, 253, 247, 235, 214, 179, 132,  84,  44,  19,   7,   2,   1,   0, 255, 254, 250, 240, 223, 196, 159, 112,  69,  36,  15,   6,   2,   1,   0, 255, 254, 253, 245, 231, 209, 176, 136,  93,  55,  27,  11,   3,   2,   1,   0, 255, 254, 253, 252, 239, 221, 194, 158, 117,  76,  42,  18,   4,   3,   2,   1,   0];
...
mod tests {
    ...
    #[test]
    fn pulses_per_block_icdf_well_formed() {
        for row in SILK_PULSES_PER_BLOCK_ICDF.iter() {
    ...
    #[test]
    fn rate_levels_icdf_well_formed() {

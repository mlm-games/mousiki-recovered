//! Port of the SILK wideband NLSF codebook tables from `silk/tables_NLSF_CB_WB.c`.
//!
//! The tables expose the wideband NLSF codebook used during stage-one and stage-two
//! decoding of line spectral frequencies.
...
impl fmt::Debug for SilkNlsfCb {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("SilkNlsfCb")
            .field("n_vectors", &self.n_vectors)
            .field("order", &self.order)
            .field("quant_step_size_q16", &self.quant_step_size_q16)
            .field("inv_quant_step_size_q6", &self.inv_quant_step_size_q6)
...
#[rustfmt::skip]
pub const SILK_NLSF_CB1_WB_WGHT_Q9: [i16; 512] = [
...
#[rustfmt::skip]
pub const SILK_NLSF_CB1_ICDF_WB: [u8; 64] = [
...
#[rustfmt::skip]
pub const SILK_NLSF_CB2_SELECT_WB: [u8; 256] = [
         0,      0,      0,      0,      0,      0,      0,      1,
...
#[rustfmt::skip]
pub const SILK_NLSF_CB2_ICDF_WB: [u8; 72] = [
...
#[rustfmt::skip]
pub const SILK_NLSF_CB2_BITS_WB_Q5: [u8; 72] = [
...
#[rustfmt::skip]
pub const SILK_NLSF_PRED_WB_Q8: [u8; 30] = [
...
#[rustfmt::skip]
pub const SILK_NLSF_DELTA_MIN_WB_Q15: [i16; 17] = [
       100,      3,     40,      3,      3,      3,      5,     14,
        14,     10,     11,      3,      8,      9,      7,      3,
       347
];

pub static SILK_NLSF_CB_WB: SilkNlsfCb = SilkNlsfCb {
    n_vectors: 32,
    order: 16,
...
mod tests {
    ...
    #[test]
    fn wideband_codebook_metadata_matches_reference() {
        assert_eq!(SILK_NLSF_CB_WB.n_vectors, 32);
        assert_eq!(SILK_NLSF_CB_WB.order, 16);
        assert_eq!(SILK_NLSF_CB_WB.quant_step_size_q16, 9830);
        assert_eq!(SILK_NLSF_CB_WB.inv_quant_step_size_q6, 427);
        assert_eq!(SILK_NLSF_CB_WB.cb1_nlsf_q8.len(), 512);
        assert_eq!(SILK_NLSF_CB_WB.cb1_nlsf_q8[0], 7);
        assert_eq!(SILK_NLSF_CB_WB.cb1_nlsf_q8[511], 237);
        assert_eq!(SILK_NLSF_CB_WB.cb1_wght_q9.len(), 512);
        assert_eq!(SILK_NLSF_CB_WB.cb1_icdf.len(), 64);
        assert_eq!(SILK_NLSF_CB_WB.ec_sel.len(), 256);
        assert_eq!(SILK_NLSF_CB_WB.ec_icdf.len(), 72);
        assert_eq!(SILK_NLSF_CB_WB.ec_rates_q5.len(), 72);
        assert_eq!(SILK_NLSF_CB_WB.delta_min_q15.len(), 17);
        assert_eq!(SILK_NLSF_CB_WB.delta_min_q15[0], 100);
        assert_eq!(SILK_NLSF_CB_WB.delta_min_q15[16], 347);
    }
}
